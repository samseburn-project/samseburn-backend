...
class CertificationTest {
    ...
    class CreateCertification {
        ...
        void setup() {
            ...
            challenge = new Challenge("제목", "설명", "https://img.com/img", LocalDateTime.now(), LocalDateTime.now(), 10, LocationType.오프라인, "서울시 강남구 테헤란로", user, category, ChallengeProgress.INPROGRESS);
        }
